...
class ZootecniaPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:  InformationCourse(grau: "Bacharelado", turno: "Diurno", duracao: "5 anos", vagas: "80 vagas (40 por semestre)", ingresso: "SISU", paginaDestino: Uri.parse("http://ufape.edu.br/CCBZO.CAMUS")),
    );
  }
}