...
class PedagogiaPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:  InformationCourse(grau: "Licenciatura", turno: "Manhã e tarde", duracao: "4.5 anos", vagas: "80 vagas (40 por semestre)", ingresso: "SISU", paginaDestino: Uri.parse("http://ufape.edu.br/CCLPE.CAMUS")),
    );
  }
}