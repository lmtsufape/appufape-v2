...
class LetrasPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const InformationCourse(grau: "Licenciatura", turno: "Noturno", duracao: "4.5 anos", vagas: "80 vagas (40 por semestre)", ingresso: "SISU", paginaDestino: "http://ufape.edu.br/CCLLE.CAMUS"),
    );
  }
}